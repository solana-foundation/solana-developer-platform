# ADR 0003: Workflow Builder architecture
...
- **Diagrams:** [system map](0003-workflow-builder-architecture.svg) — components + data flow (for readers who know the codebase) · [walkthrough](0003-workflow-builder-walkthrough.svg) — plain-language, step-by-step tour with a running example (for newcomers to this area)
