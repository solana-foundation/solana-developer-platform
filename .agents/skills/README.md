...
`packages/sdp-payments/src/ramps/providers/lightspark/client.ts` is the canonical example the skills point at. The type system is the checklist: adding your provider id to `RAMP_PROVIDERS` breaks compilation at every site you must wire.
