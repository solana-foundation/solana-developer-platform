          ...
          <form action={initializeCustody} className="grid gap-5">
            <div className="grid gap-2">
              ...
              <p className="text-xs text-[rgba(28,28,29,0.64)]">
                Privy, Coinbase CDP, Anchorage, Para, and Turnkey are managed by SDP server
                credentials. Local provider mode generates a key stored in the database and should
