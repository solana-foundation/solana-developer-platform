...
Supported locales today: `en`, `fr`, `pt`. French catalogs live under `../../messages/fr/` and Brazilian Portuguese catalogs under `../../messages/pt/`. The release workflow restores 100% key parity with English before release; at runtime, a temporarily missing localized key falls back to its English source value.
