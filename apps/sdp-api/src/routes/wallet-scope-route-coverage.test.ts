...
describe("wallet-scoped route coverage inventory", () => {
  ...
  it("tracks every issuance route that resolves a signing wallet", () => {
    ...
    expect(allRoutes.filter((route) => !nonWalletScopedRoutes.has(route))).toEqual([
      ...
      "POST /tokens/:tokenId/confidential/apply-pending-burn",
      "POST /tokens/:tokenId/confidential/approve",
      "POST /tokens/:tokenId/confidential/burn",
      "POST /tokens/:tokenId/confidential/configure",
      "POST /tokens/:tokenId/confidential/deposit",
      "POST /tokens/:tokenId/confidential/empty",
      "POST /tokens/:tokenId/confidential/mint",
      "POST /tokens/:tokenId/confidential/supply",
