 ...
 * the LOCAL harness only. The deployed devnet and mainnet allowlists are
 * asserted against a live `getConfig` by the Kora smoke suite, because only the
 * running service knows what it was actually deployed with.
 */
