...
<Tab value="curl">
```bash
curl https://sdp-api-production.solana.workers.dev/v1/payments/wallets/wal_abc123/balances \
...
const response = await fetch(
  "https://sdp-api-production.solana.workers.dev/v1/payments/wallets/wal_abc123/balances",
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://sdp-api-production.solana.workers.dev/v1/payments/wallets/wal_abc123/balances"))
