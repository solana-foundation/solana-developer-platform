...
Wallet operations are the controls and observability attached to a custody wallet, independent of the product flow that uses it. A policy can govern payments, ramps, issuance, and on-chain program interactions such as Earn vault deposits when SDP evaluates them for the selected wallet.
