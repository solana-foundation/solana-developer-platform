...
<Tab value="curl">
```bash
curl https://sdp-api-production.solana.workers.dev/v1/payments/wallets/privy_wallet_123/policies \
...
const response = await fetch(
  "https://sdp-api-production.solana.workers.dev/v1/payments/wallets/privy_wallet_123/policies",
...
<Tab value="curl">
```bash
curl -X PUT https://sdp-api-production.solana.workers.dev/v1/payments/wallets/privy_wallet_123/policies \
  -H "Authorization: Bearer sk_test_..." \
