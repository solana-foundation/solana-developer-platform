...
| **Embedded Yield** | Discover curated strategies and build self-custodial instant deposits or direct withdrawals [with or without an API key](/docs/reference/api/earn); use an API key for submission, tracking, and queued actions |
