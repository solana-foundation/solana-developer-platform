...
SDP provides tokenization, custody, payments, embedded yield, and compliance through one stable API in front of interchangeable providers. Most operations use project-scoped authentication. Embedded Yield also offers a keyless strategy, quote, and unsigned external-wallet build tier for self-custodial integrations.
...
| **Embedded Yield** | Discover curated strategies and build self-custodial deposit or withdrawal transactions, [with or without an API key](/docs/guides/embedded-yield) |
