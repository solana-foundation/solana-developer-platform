...
title: What is SDP?
icon: BookOpen
description: One API for tokenization, custody, payments, embedded yield, and compliance on Solana.
---

import { Steps, Step } from "fumadocs-ui/components/steps";
import "../../src/styles/ramp-rotator.css";

SDP provides tokenization, custody, payments, embedded yield, and compliance through one stable API in front of interchangeable providers. Most operations use project-scoped authentication. Embedded Yield also offers keyless strategy reads, previews, withdrawal-route discovery, and instant unsigned external-wallet builds for self-custodial integrations.
...
| **Embedded Yield** | Discover curated strategies and build self-custodial instant deposits or direct withdrawals [with or without an API key](/docs/guides/embedded-yield); use an API key for submission, tracking, and queued actions |
