...
- **Ramps** — fiat on-ramps and off-ramps.
  - [Ramps overview](/docs/payments/ramps) — the estimate → quote flow, request/response shapes, status states.
  - [Ramp providers](/docs/payments/ramps-providers) — capability matrix and configuration for all seven integrated providers.
