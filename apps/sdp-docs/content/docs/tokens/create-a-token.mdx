...
```typescript
const res = await fetch("https://sdp-api-production.solana.workers.dev/v1/issuance/templates", {
...
```typescript
const res = await fetch("https://sdp-api-production.solana.workers.dev/v1/issuance/tokens", {
  method: "POST",
  headers: {
