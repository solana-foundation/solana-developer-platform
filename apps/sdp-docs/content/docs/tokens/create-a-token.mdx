...
A success toast confirms creation. The token appears in the **Issuance** list with a `Pending` badge.

From here, open the token and click **Deploy** to move to the next step.
