...
description: Send tokens between wallets using SDP's payment orchestration.
steps:
  - Set up the transfer
...
![Payments overview showing confirmed 1,000 TFDT inbound transaction](/images/tokens/transfer-confirmed.png)
