...
Open the token detail page and go to the **Allowlist** tab.

Click **Add address**, enter the wallet address and an optional label, then click **Add**. The address is enforced on the next allowlist-checked operation.
...
In the **Allowlist** tab, click **Remove** next to the address and confirm the removal.
