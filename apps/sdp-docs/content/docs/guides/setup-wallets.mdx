...
<Tab value="curl">
```bash
curl -X POST https://sdp-api-production.solana.workers.dev/v1/wallets/initialize \
...
```typescript
const response = await fetch("https://sdp-api-production.solana.workers.dev/v1/wallets/initialize", {
  method: "POST",
  headers: {
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://sdp-api-production.solana.workers.dev/v1/wallets/initialize"))
...
<Tab value="curl">
```bash
curl -X POST https://sdp-api-production.solana.workers.dev/v1/wallets \
  -H "Authorization: Bearer sk_test_..." \
  -H "Content-Type: application/json" \
  -d '{
...
<Tab value="TypeScript">
```typescript
const response = await fetch("https://sdp-api-production.solana.workers.dev/v1/wallets", {
  method: "POST",
  headers: {
    "Authorization": "Bearer sk_test_...",
    "Content-Type": "application/json",
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://sdp-api-production.solana.workers.dev/v1/wallets"))
    .header("Authorization", "Bearer sk_test_...")
    .header("Content-Type", "application/json")
    .POST(HttpRequest.BodyPublishers.ofString("""
        {
...
<Tab value="curl">
```bash
curl "https://sdp-api-production.solana.workers.dev/v1/wallets?view=summary" \
  -H "Authorization: Bearer sk_test_..."
```
</Tab>
<Tab value="TypeScript">
```typescript
const response = await fetch("https://sdp-api-production.solana.workers.dev/v1/wallets?view=summary", {
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://sdp-api-production.solana.workers.dev/v1/wallets?view=summary"))
    .header("Authorization", "Bearer sk_test_...")
    .GET()
    .build();
```
...
<Tab value="curl">
```bash
curl -X POST https://sdp-api-production.solana.workers.dev/v1/wallets/default-wallet \
  -H "Authorization: Bearer sk_test_..." \
  -H "Content-Type: application/json" \
...
<Tab value="TypeScript">
```typescript
await fetch("https://sdp-api-production.solana.workers.dev/v1/wallets/default-wallet", {
  method: "POST",
  headers: {
    "Authorization": "Bearer sk_test_...",
    "Content-Type": "application/json",
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://sdp-api-production.solana.workers.dev/v1/wallets/default-wallet"))
    .header("Authorization", "Bearer sk_test_...")
    .header("Content-Type", "application/json")
    .POST(HttpRequest.BodyPublishers.ofString("""
