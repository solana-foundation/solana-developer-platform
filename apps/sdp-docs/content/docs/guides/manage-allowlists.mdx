...
<Tab value="curl">
```bash
curl -X POST https://sdp-api-production.solana.workers.dev/v1/issuance/tokens/tok_abc123/allowlist \
...
const response = await fetch(
  "https://sdp-api-production.solana.workers.dev/v1/issuance/tokens/tok_abc123/allowlist",
  {
    method: "POST",
    headers: {
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://sdp-api-production.solana.workers.dev/v1/issuance/tokens/tok_abc123/allowlist"))
...
<Tab value="curl">
```bash
curl https://sdp-api-production.solana.workers.dev/v1/issuance/tokens/tok_abc123/allowlist \
  -H "Authorization: Bearer sk_test_..."
```
</Tab>
<Tab value="TypeScript">
...
```bash
curl -X DELETE \
  https://sdp-api-production.solana.workers.dev/v1/issuance/tokens/tok_abc123/allowlist/alw_abc123 \
  -H "Authorization: Bearer sk_test_..."
```
</Tab>
<Tab value="TypeScript">
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://sdp-api-production.solana.workers.dev/v1/issuance/tokens/tok_abc123/allowlist/alw_abc123"))
    .header("Authorization", "Bearer sk_test_...")
    .DELETE()
    .build();
```
