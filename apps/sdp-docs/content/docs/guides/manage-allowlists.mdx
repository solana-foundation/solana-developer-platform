...
```typescript title="add-allowlist-address.ts"
...
<Tab value="Java">
```java title="AddAllowlistAddress.java"
...
<Tab value="TypeScript">
```typescript title="list-allowlist-entries.ts"
const response = await fetch(
  "https://api.solana.com/v1/issuance/tokens/tok_abc123/allowlist",
...
<Tab value="Java">
```java title="ListAllowlistEntries.java"
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://api.solana.com/v1/issuance/tokens/tok_abc123/allowlist"))
    .header("Authorization", "Bearer sk_test_...")
    .GET()
...
<Tab value="TypeScript">
```typescript title="remove-allowlist-address.ts"
await fetch(
  "https://api.solana.com/v1/issuance/tokens/tok_abc123/allowlist/alw_abc123",
  {
    method: "DELETE",
...
<Tab value="Java">
```java title="RemoveAllowlistAddress.java"
HttpRequest request = HttpRequest.newBuilder()
