...
<Tab value="curl">
```bash
curl -X POST https://sdp-api-production.solana.workers.dev/v1/api-keys \
...
```typescript
const response = await fetch("https://sdp-api-production.solana.workers.dev/v1/api-keys", {
  method: "POST",
  headers: {
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://sdp-api-production.solana.workers.dev/v1/api-keys"))
...
<Tab value="curl">
```bash
curl -X POST https://sdp-api-production.solana.workers.dev/v1/api-keys/key_abc123/rotate \
  -H "Authorization: Bearer sk_test_..." \
  -H "Content-Type: application/json" \
...
const response = await fetch(
  "https://sdp-api-production.solana.workers.dev/v1/api-keys/key_abc123/rotate",
  {
    method: "POST",
    headers: {
      "Authorization": "Bearer sk_test_...",
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://sdp-api-production.solana.workers.dev/v1/api-keys/key_abc123/rotate"))
    .header("Authorization", "Bearer sk_test_...")
    .header("Content-Type", "application/json")
    .POST(HttpRequest.BodyPublishers.ofString("""
        { "gracePeriodHours": 24 }"""))
...
<Tab value="curl">
```bash
curl -X DELETE https://sdp-api-production.solana.workers.dev/v1/api-keys/key_abc123 \
  -H "Authorization: Bearer sk_test_..." \
  -H "Content-Type: application/json" \
...
<Tab value="TypeScript">
```typescript
await fetch("https://sdp-api-production.solana.workers.dev/v1/api-keys/key_abc123", {
  method: "DELETE",
  headers: {
    "Authorization": "Bearer sk_test_...",
    "Content-Type": "application/json",
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://sdp-api-production.solana.workers.dev/v1/api-keys/key_abc123"))
    .header("Authorization", "Bearer sk_test_...")
    .header("Content-Type", "application/json")
