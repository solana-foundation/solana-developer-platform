...
<Tab value="TypeScript">
```typescript title="freeze-account.ts"
const response = await fetch(
...
<Tab value="Java">
```java title="UnfreezeAccount.java"
HttpRequest request = HttpRequest.newBuilder()
...
<Tab value="TypeScript">
```typescript title="list-frozen-accounts.ts"
const response = await fetch(
...
<Tab value="Java">
```java title="ListFrozenAccounts.java"
HttpRequest request = HttpRequest.newBuilder()
...
<Tab value="TypeScript">
```typescript title="pause-token.ts"
await fetch(
...
<Tab value="TypeScript">
```typescript title="unpause-token.ts"
await fetch(
...
<Tab value="TypeScript">
```typescript title="seize-tokens.ts"
await fetch(
