...
<Tab value="curl">
```bash
curl -X POST /v1/compliance/address-screenings \
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("/v1/compliance/address-screenings"))
...
<Tab value="curl">
```bash
curl -X POST /v1/issuance/tokens/tok_abc123/freeze \
  -H "Authorization: Bearer sk_test_..." \
  -H "Content-Type: application/json" \
  -d '{
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("/v1/issuance/tokens/tok_abc123/freeze"))
    .header("Authorization", "Bearer sk_test_...")
    .header("Content-Type", "application/json")
    .POST(HttpRequest.BodyPublishers.ofString("""
        {
...
<Tab value="curl">
```bash
curl -X POST /v1/issuance/tokens/tok_abc123/unfreeze \
  -H "Authorization: Bearer sk_test_..." \
  -H "Content-Type: application/json" \
...
```typescript
await fetch(
  "/v1/issuance/tokens/tok_abc123/unfreeze",
  {
    method: "POST",
    headers: {
      "Authorization": "Bearer sk_test_...",
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("/v1/issuance/tokens/tok_abc123/unfreeze"))
    .header("Authorization", "Bearer sk_test_...")
    .header("Content-Type", "application/json")
    .POST(HttpRequest.BodyPublishers.ofString("""
        { "accountAddress": "3xYZa...2aBc" }"""))
...
<Tab value="curl">
```bash
curl /v1/issuance/tokens/tok_abc123/frozen \
  -H "Authorization: Bearer sk_test_..."
```
</Tab>
<Tab value="TypeScript">
```typescript
const response = await fetch(
  "/v1/issuance/tokens/tok_abc123/frozen",
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("/v1/issuance/tokens/tok_abc123/frozen"))
    .header("Authorization", "Bearer sk_test_...")
    .GET()
    .build();
```
...
<Tab value="curl">
```bash
curl -X POST /v1/issuance/tokens/tok_abc123/pause \
  -H "Authorization: Bearer sk_test_..."
```
</Tab>
<Tab value="TypeScript">
```typescript
await fetch(
  "/v1/issuance/tokens/tok_abc123/pause",
  {
    method: "POST",
    headers: { "Authorization": "Bearer sk_test_..." },
  }
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("/v1/issuance/tokens/tok_abc123/pause"))
    .header("Authorization", "Bearer sk_test_...")
...
<Tab value="curl">
```bash
curl -X POST /v1/issuance/tokens/tok_abc123/unpause \
  -H "Authorization: Bearer sk_test_..."
```
</Tab>
<Tab value="TypeScript">
```typescript
await fetch(
  "/v1/issuance/tokens/tok_abc123/unpause",
  {
    method: "POST",
    headers: { "Authorization": "Bearer sk_test_..." },
  }
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("/v1/issuance/tokens/tok_abc123/unpause"))
    .header("Authorization", "Bearer sk_test_...")
    .POST(HttpRequest.BodyPublishers.noBody())
    .build();
```
...
<Tab value="curl">
```bash
curl -X POST /v1/issuance/tokens/tok_abc123/seize \
  -H "Authorization: Bearer sk_test_..." \
  -H "Content-Type: application/json" \
...
```typescript
await fetch(
  "/v1/issuance/tokens/tok_abc123/seize",
  {
    method: "POST",
    headers: {
      "Authorization": "Bearer sk_test_...",
...
```java
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("/v1/issuance/tokens/tok_abc123/seize"))
    .header("Authorization", "Bearer sk_test_...")
    .header("Content-Type", "application/json")
