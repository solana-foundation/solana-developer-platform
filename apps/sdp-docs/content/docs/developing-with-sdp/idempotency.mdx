...
1. The first request creates the record — a transfer, a batch, a recurring-payment intent, an issuance transaction — carrying your key and a fingerprint of the normalized request payload.
...
| Payments — recurring payments | `POST /v1/payments/recurring-payments` | Per project |
