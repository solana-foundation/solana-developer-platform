...
Embedded Yield strategy reads, deposit and withdrawal previews, withdrawal-route discovery, and instant deposit or direct-withdrawal builders also support [keyless access](/docs/reference/api/earn). Those requests have no organization or project identity and cannot submit transactions, build queued request or cancellation actions, or read tenant state.
