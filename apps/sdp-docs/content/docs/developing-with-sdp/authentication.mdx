...
The Embedded Yield strategy catalogue, quote routes, and unsigned external-wallet transaction builders also support [keyless access](/docs/guides/embedded-yield#without-an-api-key). Those requests have no organization or project identity and cannot submit transactions or read tenant state.
