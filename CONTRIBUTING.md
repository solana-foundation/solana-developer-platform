...
- [README.md](./README.md) — Node `>=24` and `pnpm@10.16.0` prerequisites (listed under [README "Local Development"](./README.md#local-development)), and the release/deploy model.
