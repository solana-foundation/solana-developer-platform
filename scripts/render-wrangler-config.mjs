...
/**
 * Copies wrangler.toml to outPath with the target environment's placeholder
 * Hyperdrive/KV resource IDs replaced by the real IDs from the environment.
 * Worker vars are untouched — non-secret config reaches deployed Workers via
 * the Cloudflare secret sync (see project-secrets.mjs).
 */
