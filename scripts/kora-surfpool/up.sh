...
KORA_IMAGE="${KORA_IMAGE:-ghcr.io/solana-foundation/kora:e9bc391}"
...
KORA_SURFPOOL_CLIENT_TIMEOUT_MS="${KORA_SURFPOOL_CLIENT_TIMEOUT_MS:-45000}"
KORA_SURFPOOL_CONFIRMATION_TIMEOUT_MS="${KORA_SURFPOOL_CONFIRMATION_TIMEOUT_MS:-30000}"
...
write_runtime_env() {
  umask 077
  {
    ...
    echo "KORA_TIMEOUT_MS=$(shell_quote "${KORA_SURFPOOL_CLIENT_TIMEOUT_MS}")"
    echo "KORA_SURFPOOL_CONFIRMATION_TIMEOUT_MS=$(shell_quote "${KORA_SURFPOOL_CONFIRMATION_TIMEOUT_MS}")"
...
KORA_PORT="$(url_port "${KORA_RPC_URL}")"
...
echo "Warming the complete Kora sign-and-send path."
KORA_RPC_URL="${KORA_RPC_URL}" \
SOLANA_RPC_URL="${SURFPOOL_RPC_URL}" \
KORA_TIMEOUT_MS="${KORA_SURFPOOL_CLIENT_TIMEOUT_MS}" \
KORA_SURFPOOL_CONFIRMATION_TIMEOUT_MS="${KORA_SURFPOOL_CONFIRMATION_TIMEOUT_MS}" \
  node "${ROOT_DIR}/packages/sdp-api-integration/scripts/kora-surfpool-warmup.mjs"
