...
- Do not ask authors to add or update French or other localized catalogs alongside English source changes. The release workflow finds missing locale keys and Eve adds them to `sdp/release-main`.
