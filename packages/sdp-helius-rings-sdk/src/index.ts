 ...
 * major's type without any error. So the barrel exports one factory that takes
 * plain strings and returns a port whose types all come from the Kit-free
 * `@sdp/helius-rings`. Anything inside this package reaches its siblings by
