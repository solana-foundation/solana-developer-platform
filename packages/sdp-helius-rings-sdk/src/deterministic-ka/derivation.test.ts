...
describe("deriveMaterial", () => {
  ...
  // Restates the derivation the plan specifies — salt, info strings and byte
  // lengths — from outside the module, so the pinned identity below is anchored
  // to a reviewable specification rather than to whatever the code produced.
