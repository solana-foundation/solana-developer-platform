...
export const RAMP_PROVIDERS = ["moonpay", "lightspark", "bvnk", "moneygram", "coinbase_onramp"] as const;
...
const ENTERPRISE_PROVIDER_DEFAULTS: OrganizationProviderEntitlements = {
  ...
  ramps: createBooleanRecord(RAMP_PROVIDERS, ["moonpay", "lightspark", "bvnk", "moneygram", "coinbase_onramp"]),
};
