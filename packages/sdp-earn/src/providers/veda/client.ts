...
/**
 * Veda vault-infra client — scaffold stub. Every operation throws
 * NOT_IMPLEMENTED until the integration lands; the class exists so the
 * registry, availability gating, and route dispatch are all real today.
 */
export class VedaEarnClient implements EarnVaultProvider {
